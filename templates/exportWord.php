...
$arrayIdProjet = $manager->getList("select idprojet from rapport");
...
//---------------------------------------------------------------------------------------------------------------------------------------------------------    
        ...
        $widthLogoCentrale = sizeLogo($arrayInfoImgLogoCentrale, 60)[1];
...
//---------------------------------------------------------------------------------------------------------------------------------------------------------    
        ...
        $widthLogoLab = sizeLogo($arrayInfoImgLogoLabo, 60)[1];
