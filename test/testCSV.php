...
file_put_contents("../tmp/export_projet_4.csv", $data);
...
$row6 = $manager->getListbyArray("SELECT titre FROM projet p,creer c,concerne co WHERE p.idprojet = co.idprojet_projet AND c.idprojet_projet = p.idprojet  AND co.idcentrale_centrale =? AND  datedebutprojet is not null 
