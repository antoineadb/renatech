...
<div style="height: 350px;">
    ...
    <script>
        ...
        require([
            ...
            request.get("<?php echo '/' . REPERTOIRE; ?>/tmp/projetPorteur.json", {
                handleAs: "json"
            }).then(function(data) {
                ...
                function hrefFormatterDatedemande(dateDemande, idx) {
                    ...
                    return "<a  href=\"<?php echo '/' . REPERTOIRE; ?>/recherche_porteur/<?php echo $lang; ?>/" + idprojet + "\">" + dateDemande + "</a>";
                }
                function hrefFormatterdatedebutprojet(datedebutprojet, idx) {
                    var item = grideusercompte.getItem(idx);
                    var idprojet = item.idprojet;
                    return "<a  href=\"<?php echo '/' . REPERTOIRE; ?>/recherche_porteur/<?php echo $lang; ?>/" + idprojet + "\">" + datedebutprojet + "</a>";
                }
                function hrefFormatterNumero(numero, idx) {
                    var item = grideusercompte.getItem(idx);
                    var idprojet = item.idprojet;
                    return "<a  href=\"<?php echo '/' . REPERTOIRE; ?>/recherche_porteur/<?php echo $lang; ?>/" + idprojet + "\">" + numero + "</a>";
                }
                function hrefFormatterTitre(titre, idx) {
                    var item = grideusercompte.getItem(idx);
                    var idprojet = item.idprojet;
                    return "<a  href=\"<?php echo '/' . REPERTOIRE; ?>/recherche_porteur/<?php echo $lang; ?>/" + idprojet + "\">" + titre + "</a>";
                }
