...
<div id="global">
    ...
    <form data-dojo-type="dijit/form/Form" name="exportProjet" id="exportProjet" method="post" onsubmit="unselect()" action="<?php echo '/'.REPERTOIRE ;?>/exportprojet.php?lang=<?php echo $lang; ?>"  >
