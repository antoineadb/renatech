...
<div id="global" >
    ...
    <div style="padding-top: 75px;">
        ...
        <div data-dojo-type="dijit/layout/TabContainer" style="margin-top:25px;width: 1050px;font-size: 1.2em;" doLayout="false" selected="true" >
            <div data-dojo-type="dijit/layout/ContentPane" title="<?php echo "<div title='".TXT_NBPROJET.': '.$nbprojet."'>".TXT_PROJETMACENTRALE."</div>"; ?>" style="height:500px;white-space: normal" >
