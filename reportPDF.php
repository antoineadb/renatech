...
<table>
    <tr>
        <td style='width:75%;'>
            <table>
                ...
                <tr><td><strong>Funding source: </strong></td></tr>
                <tr><td><?php echo $fundingsource; ?></td></tr>
                <tr><td><strong >Collaborators in the project of consortium: </strong></td></tr>
                <tr><td><?php echo $collaborator; ?></td></tr>
            </table>
        </td>    
        <td style='width:25%;' >
            <?php             
                ...
                if($arrayInfoImg[0]>182){
                    $fWidth = 182/$arrayInfoImg[0];
                    $fHeight = 91/$arrayInfoImg[1];
            ...
            ?>
            <img   height="<?php echo $height; ?>" width="<?php echo $width; ?>" src="<?php echo $logo; ?>" style="padding-right: 50px">
        </td>
    </tr>
</table>   
    <hr>
    <table>
        ...
        <td style="width:30%"><strong>Starting date:  </strong><?php echo date("d-Y", strtotime($startingdate)); ?></td>        
        </tr>
    </table>
    <hr>
     <table>
    ...
    <table style="">
        <tr>
            ...
            <?php if($figure!=''){             
                ...
                if($arrayInfoImg[0]>720){//si Width >700px
                    $facteurW = 720/$arrayInfoImg[0];
                    $width  =$facteurW*$arrayInfoImg[0];
                }else{
                    $width = $arrayInfoImg[0];
                }
            ?>
            <img style="max-height: 200px;max-width: 800px" align="left"  src="<?php echo $figure; ?>"  height="<?php echo $height;?>" width="<?php echo $width;?>">
            <?php } ?>
        </td>
        </tr>
    </table>
