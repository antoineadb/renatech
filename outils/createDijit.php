            ...
            function(html, dom, on) {
                on(dom.byId("setContent"), "click", function() {
                    ...
                    html.set(dom.byId("nomresponsable"), '<tbody>'
                            + '<tr>'
                            + '<td id="nomResp"><label for="nomresponsable" style="width:300px"><?php echo TXT_NOMRESPONSABLE.'*:'; ?></label></td>'
                            + '<td><input type="text"  id="nomresponsable" name="nomresponsable" data-dojo-type="dijit/form/ValidationTextBox" value="" \n\
placeholder="<?php echo  TXT_NOMRESPONSABLE; ?>"'
                    ...
                    html.set(dom.byId("emailresponsable"), '<tbody>'
                            + '<tr>'
                            + '<td id="emailResp"><label for="emailResponsable" style="width:300px"><?php echo TXT_RESPMAILMAIL.'*:'; ?></label></td>'
                            + '<td><input type="text"  id="emailResponsable" name="emailResponsable" data-dojo-type="dijit/form/ValidationTextBox" value="" placeholder="<?php echo TXT_RESPMAILMAIL; ?>"'
                            + 'autocomplete="on"   style="width: 317px;margin-left:5px"'
                ...
                on(dom.byId("setContentne"), "click", function() {
                    ...
                    html.set(dom.byId("autreEmployeur"), '<tbody>'
                            + '<tr>'
                            + '<td id="autreEmpl"><label for="autreEmployeur" style="width:300px"><?php	echo	TXT_AUTREEMPLOYEUR.'*:';	?></label></td>'
                            + '<td><input type="text"  id="autreEmployeur" name="autreEmployeur" data-dojo-type="dijit/form/ValidationTextBox" value="" placeholder="<?php	echo	TXT_AUTREEMPLOYEUR;	?>"'
                            + 'autocomplete="on"    style="width: 317px;margin-left:5px"'
                            + 'data-dojo-props="regExp:\'[a-zA-ZàáâäãåèéêëìíîïòóôöõøùúûüÿýñçčšžÀÁÂÄÃÅÈÉÊËÌÍÎÏÒÓÔÖÕØÙÚÛÜŸÝÑßÇŒÆČŠŽ∂ð%&:0-9-\\042\\\'\\’\\=\\0133\\0135\\+\\_\ \,\\.\\-]+\'"'
                            + 'required= true'
                            + 'data-dojo-invalidMessage="<?php	echo TXT_ERRSTRING;?>" />'
                ...
                on(dom.byId("setContenttu"), "click", function() {
                    ...
                    html.set(dom.byId("autreTutelle"), '<tbody>'
                            + '<tr>'
                            + '<td id="autreTu"><label for="autreTutelle" style="width:300px"><?php	echo	TXT_AUTRETUTELLE.'*:';	?></label></td>'
    ...
    value="" placeholder="<?php	echo	addslashes(TXT_AUTRETUTELLE);	?>"'
                ...
                on(dom.byId("setContentdi"), "click", function() {
                    ...
                    html.set(dom.byId("autreDiscipline"), '<tbody>'
                            + '<tr>'
                            + '<td id="autreDi"><label for="autreDiscipline" style="width:300px"><?php	echo	TXT_AUTREDISCIPLINE.'*:';	?></label></td>'
                            + '<td><input type="text"  id="autreDiscipline" name="autreDiscipline" data-dojo-type="dijit/form/ValidationTextBox" value="" placeholder="<?php	echo	TXT_AUTREDISCIPLINE;	?>"'
                            + 'autocomplete="on"    style="width: 317px;margin-left:5px"'
                            + 'data-dojo-props="regExp:\'[a-zA-ZàáâäãåèéêëìíîïòóôöõøùúûüÿýñçčšžÀÁÂÄÃÅÈÉÊËÌÍÎÏÒÓÔÖÕØÙÚÛÜŸÝÑßÇŒÆČŠŽ∂ð%&:0-9-\\042\\\'\\’\\=\\0133\\0135\\+\\_\ \,\\.\\-]+\'"'
                            + 'required= true'
                            + 'data-dojo-invalidMessage="<?php	echo TXT_ERRSTRING;	?>" />'
