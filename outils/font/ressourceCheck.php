    ...
    <div id='chck'>
        ...
        if ($lang == 'fr') {
            ...
            for ($i = 0; $i < $nbrow; $i++) {
                ...
                <a class='infoBulle' href='#'>&nbsp;<img src='<?php echo '/".REPERTOIRE."/styles/img/help.gif' height='13px' width='13px' /><span style='width: 250px;border-radius:5px;padding:10px;'>" . $aide . "</span></a></label><br>";
                } else {
