...
if (!empty($idprojet)) {
    ...
    $row = $manager->getList2("SELECT acronyme,nbrun,nbplaque,nbheure,nbeleve,contactscentraleaccueil,typeformation,dureeprojet,datedebuttravaux,descriptionautrecentrale,etapeautrecentrale
    ...
    switch ($idstatutprojet) {
        ...
        case "3":
            ...
            break;
        case "4":
            echo '<legend style="margin-left:20px"><b>' . TXT_STATUTPROJETS.': '. TXT_REFUSE . '</b></legend>'; //projet refusé
            $bool = 'true';
            $bool1 = 'true';
            $disabled = "'disabled'";
            break;
        case "6":
            echo '<legend style="margin-left:20px"><b>' . TXT_STATUTPROJETS.': '. TXT_FINI . '</b></legend>'; //projet fini
            $bool = 'false';
            $bool1 = '';
            $disabled = "''";
            break;
        case "7":
            echo '<legend style="margin-left:20px"><b>' . TXT_STATUTPROJETS.': '. TXT_CLOTURE . '</b></legend>'; //projet cloturé
            $bool = 'true';
            $bool1 = 'true';
            $disabled = "'disabled'";
            break;
    ...
    $nomEntLabo = $rowResult[0]['entrepriselaboratoire'];
