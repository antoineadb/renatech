    ...
    <div id='chck'>
        ...
        if ($lang == 'fr') {
            ...
            for ($i = 0; $i < $nbrow; $i++) {
                ...
                <label for " .'re'. $row[$i]['idressource'] . " class='opt' > " . removeDoubleQuote($row[$i]['libelleressourceen']) . "
                <a class='infoBulle' href='#'>&nbsp;<img src='/".REPERTOIRE."/styles/img/help.gif' height='13px' width='13px'/><span style='width: 250px;border-radius:5px;padding:10px;'>" . $aide . "</span></a></label><br>";
                } else {
                ...
                <label for " . 're'.$row[$i]['idressource'] . " class='opt' style='font-weight:normal' > " . removeDoubleQuote($row[$i]['libelleressourceen']) . "
                <a class='infoBulle' href='#'>&nbsp;<img src='/".REPERTOIRE."/styles/img/help.gif' height='13px' width='13px'/><span style='width: 250px;border-radius:5px;padding:10px;'>" . $aide . "</span></a></label><br>";
            }
        }
        }
