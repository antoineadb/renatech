...
if (isset($_SESSION['pseudo'])) {
    ...
    $cacheRapport = new Cache(REP_ROOT . '/cache/'.LIBELLECENTRALEUSER.'/', 60); //1 heure
    $cacheSoustraitance = new Cache(REP_ROOT . '/cache/'.LIBELLECENTRALEUSER.'/', 60); //1 heure
    $cacheTous = new Cache(REP_ROOT . '/cache/'.LIBELLECENTRALEUSER.'/', 60); //1 heure
    $cacheEncoursRealisation = new Cache(REP_ROOT . '/cache/'.LIBELLECENTRALEUSER.'/', 60); //1 heure
    $cacheAccepte = new Cache(REP_ROOT . '/cache/'.LIBELLECENTRALEUSER.'/', 60); //1 heure
    $cacheEnAttente = new Cache(REP_ROOT . '/cache/'.LIBELLECENTRALEUSER.'/', 60); //1 heure
    $cacheFinis = new Cache(REP_ROOT . '/cache/'.LIBELLECENTRALEUSER.'/', 60); //1 heure
    $cacheEncoursAnalyse = new Cache(REP_ROOT . '/cache'.LIBELLECENTRALEUSER.'/', 60); //1 heure
    $cacheCloture = new Cache(REP_ROOT . '/cache'.LIBELLECENTRALEUSER.'/', 60); //1 heure
    $cacheRefuse = new Cache(REP_ROOT . '/cache'.LIBELLECENTRALEUSER.'/', 60); //1 heure
