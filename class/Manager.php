...
//------------------------------------------------------------------------------------------------------------
    public function updateProjetphase2(Projetphase2 $projet2, $idprojet) {
        try {
            ...
            $requete->bindParam(6, $centralepartenaireprojet, PDO::PARAM_STR);
            $requete->bindParam(7, $idthematique, PDO::PARAM_INT);
            $requete->bindParam(8, $idautrethematique, PDO::PARAM_INT);
            $requete->bindParam(9, $descriptiftechnologique, PDO::PARAM_STR);
            $requete->bindParam(10, $attachementdesc, PDO::PARAM_STR);
            $requete->bindParam(11, $verrouidentifiee, PDO::PARAM_STR);
            $requete->bindParam(12, $nbplaque, PDO::PARAM_INT);
            $requete->bindParam(13, $nbrun, PDO::PARAM_INT);
            $requete->bindParam(14, $envoidevis, PDO::PARAM_BOOL);
            $requete->bindParam(15, $emailrespdevis, PDO::PARAM_STR);
            $requete->bindParam(16, $reussite, PDO::PARAM_STR);
            $requete->bindParam(17, $refinterneprojet, PDO::PARAM_STR);
            $requete->bindParam(18, $devtechnologique, PDO::PARAM_BOOL);
            $requete->bindParam(19, $nbeleve, PDO::PARAM_INT);
            $requete->bindParam(20, $nomformateur, PDO::PARAM_STR);
            $requete->bindParam(21, $partenaire1, PDO::PARAM_STR);
            $requete->bindParam(22, $porteurprojet, PDO::PARAM_BOOL);
            $requete->bindParam(23, $dureestime, PDO::PARAM_INT);
            $requete->bindParam(24, $descriptionautrecentrale, PDO::PARAM_STR);
            $requete->bindParam(25, $etapeautrecentrale, PDO::PARAM_BOOL);
            $requete->bindParam(26, $centraleproximite, PDO::PARAM_BOOL);
...
//------------------------------------------------------------------------------------------------------------
    ...
    public function deleteCentralePartenaireProjet($idprojet) {
        try {
            $this->_db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
            $this->_db->beginTransaction();
            $requete = $this->_db->prepare("UPDATE projet SET partenaire_centrale_id = 0 WHERE idprojet=? ");
            $requete->bindParam(1, $idprojet, PDO::PARAM_INT);
            $requete->execute();
            $this->_db->commit();
        } catch (Exception $exc) {
