...
<div id="global">
    ...
    <div id="navigation">
        <form  method="post" action="<?php echo '/'.REPERTOIRE; ?>/ctrladminuser.php?lang=<?php echo $lang; ?>" id='affectationprojetadmin' name='affectationprojetadmin'   >
            <fieldset id="ident" style="border-color: #5D8BA2;width: 1006px;padding-bottom:10px;padding-top:8px;margin-top:15px" >
                ...
                <table>
                    <tr>
                        ...
                        <td>&nbsp;&nbsp</td>
                        <td valign="bottom" >
                            <input name ="rechercheUseradmin" type="submit"  value="<?php echo TXT_BOUTONRECHERCHE; ?>"  class="maj" onclick="
            ...
            <?php if (isset($_POST['nom']) || isset($_POST['prenom'])) { ?>
                <fieldset id='droit' style="border-color: #5D8BA2;width: 1037px;padding:5px; margin-top: 15px" >
                    ...
                    if (isset($_GET['idprojet']) && !empty($_GET['idprojet'])) {
                        ...
                        $array = $manager->getList2("select titre,numero from projet where idprojet=?", $_GET['idprojet']);
