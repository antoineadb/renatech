...
$data = utf8_decode("".TXT_DATEINSCRIPTION.";".TXT_NOM.";".TXT_PRENOM.";".TXT_ADRESSE.";".TXT_MAIL.";".TXT_PAYS.";".TXT_NOMRESPONSABLE.";".TXT_EMAILRESPONSABLE.";".TXT_TYPEUTILISATEUR.";".TXT_CENTRALE.";".TXT_CODEUNITE.";".TXT_AUTRECODEUNITE.";".TXT_NOMENTELABO."; ".TXT_NOMENTREPRISE.";".TXT_QUALITE.";".TXT_USER.";".TXT_NOMEMPLOYEUR.";".TXT_TUTELLE.";".TXT_DISCIPLINESCIENTIFIQUE.";".TXT_NBPROJETCREER.";".TXT_NBPROJETAFFECTER.";");
$data .= "\n";
if ($idtypeuser == ADMINNATIONNAL) {
  ...
  iddiscipline_disciplinescientifique,idpays_pays,acronymelaboratoire,fax FROM utilisateur,loginpassword WHERE idlogin_loginpassword = idlogin and idqualitedemandeuraca_qualitedemandeuraca is not null and idcentrale_centrale is not null";
  ...
  idautrecodeunite_autrecodeunite,entrepriselaboratoire,nomentreprise,idqualitedemandeuraca_qualitedemandeuraca,idemployeur_nomemployeur,idtutelle_tutelle,idautrestutelle_autrestutelle,
  idautrediscipline_autredisciplinescientifique,idautrenomemployeur_autrenomemployeur,idqualitedemandeurindust_qualitedemandeurindust,idlogin_loginpassword,
  iddiscipline_disciplinescientifique,idpays_pays,acronymelaboratoire,fax
...
u.iddiscipline_disciplinescientifique,u.idlogin_loginpassword,u.idpays_pays,u.idautrecodeunite_autrecodeunite,u.acronymelaboratoire,u.idqualitedemandeurindust_qualitedemandeurindust
...
//NOM EMPLOYEUR
    ...
    $Adresse = str_replace("''", "'", stripslashes(utf8_decode($row[$i]['adresse']))) . 'Ville= ' . str_replace("''", "'", stripslashes(utf8_decode($row[$i]['ville']))) . ',CP= ' . $row[$i]['codepostal'] . ",Tel= " . $row[$i]['telephone'];
    $adresse = str_replace(";", ",", $Adresse);
//DATE POUR LE NOM DU FICHIER CSV DE SORTIE
    $data .= "" . str_replace("''", "'", $row[$i]['datecreation']) . ";" .
            str_replace("''", "'", stripslashes(utf8_decode(($row[$i]['nom'])))) . ";" .
            str_replace("''", "'", stripslashes(utf8_decode(($row[$i]['prenom'])))) . ";" .
            $adresse . ";" .
            str_replace("''", "'", $row[$i]['mail']) . ";" .
            utf8_decode($nompays) . ";" .
            str_replace("''", "'", stripslashes(utf8_decode(($row[$i]['nomresponsable'])))) . ";" .
            str_replace("''", "'", stripslashes(utf8_decode(($row[$i]['mailresponsable'])))) . ";" .
            utf8_decode($libelletypeutilisateur) . ";" .
            utf8_decode($libellecentrale) . ";" .
            utf8_decode($codeunite) . ";" .
            str_replace("''", "'", stripslashes(utf8_decode($autrecodeunite))) . ";" .
            str_replace("''", "'", stripslashes(utf8_decode($entrepriselaboratoire))) . ";" .
            str_replace("''", "'", stripslashes(utf8_decode($nomentreprise))) . ";" .
            utf8_decode($libqualite) . ";" .
            utf8_decode($libtypeuser) . ";" .
            str_replace("''", "'", stripslashes(utf8_decode($nomemployeur))) . ";" .
            str_replace("''", "'", stripslashes(utf8_decode($libtutelle))) . ";" .
            str_replace("''", "'", stripslashes(utf8_decode($libdiscipline))) . ";" .
            $nbprojetcreer . ";" .
            $nbprojetaffecter . "\n";
}
