...
AND p.idprojet = pr.idprojet_projet AND co.idprojet_projet = p.idprojet AND co.idcentrale_centrale = ce.idcentrale and ce.idcentrale != ? AND extract(year from datedebutprojet)>2012  
group by ce.libellecentrale,annee,mois order by ce.libellecentrale)", array(IDCENTRALEAUTRE));
