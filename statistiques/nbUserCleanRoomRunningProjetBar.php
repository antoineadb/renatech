...
AND p.idprojet = pr.idprojet_projet AND co.idprojet_projet = p.idprojet AND co.idcentrale_centrale = ce.idcentrale and ce.idcentrale != ? AND extract(year from datedebutprojet)>2012  and idstatutprojet_statutprojet=?
