...
<script src="<?php echo '/' . REPERTOIRE ?>/js/autocompleteCompte.js"></script>
<div id="global">
    <?php
            ...
            <fieldset id="ident" style="border-color: #5D8BA2;width: 1008px;padding-bottom:30px;padding-top:10px;font-size:1.2em" >
                ...
                <table>
                    ...
                    <tr>
                        ...
                        placeholder="<?php echo TXT_SAISIRUNELETTRE; ?>" name="nom" onkeyup="autocomplete()"  id="nom" data-dojo-type="dijit/form/ValidationTextBox" autocomplete="off"/></td>
                        <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    ...
                    <div id="compteutilisateuraca" >
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" style="width: 318px;margin-left: 50px"  required="required" name="nomuser" id="nomuser"
                                           data-dojo-type="dijit/form/ValidationTextBox" value="<?php echo removeDoubleQuote($nom); ?>"    />
                                </td>
                            </tr>
                            <tr>
                                <td valign="top"><?php echo TXT_PRENOM; ?></td><td></td>
                                <td>
                                    <input type="text" style="width: 318px;margin-left: 50px"  required="required" name="prenomuser" 
                                           data-dojo-type="dijit/form/ValidationTextBox" id="prenomuser" value="<?php echo removeDoubleQuote($prenom); ?>"   />
                                </td>
                            </tr>
                            <tr>
